...
import net.anandsingh.moviez.utils.GridSpacingItemDecoration;
import net.anandsingh.moviez.adapter.MoviesAdapter;
import net.anandsingh.moviez.api.RetrofitClient;
import net.anandsingh.moviez.api.MovieDBApi;
